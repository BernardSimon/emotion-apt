...
import { useGlobalState, useUserProfile } from "~~/services/store/store";
...
const InitModal = ({ open, onFinished, onClosed }: { open: boolean; onClosed: () => void; onFinished: () => void }) => {
  ...
  const [counselingHours, setCounselingHours] = useState("Not Provider");
              ...
              <div className="flex gap-4">
                <label className="flex items-center gap-2">
                  <input
                    ...
                    onChange={() => {
                      ...
                      if (!showCounselingHours) {
                        setCounselingHours("Not Provided");
                      }
                    }}
                  />
                  <span>Yes</span>
                ...
                <label className="flex items-center gap-2">
                  <input
                    ...
                    className="radio radio-primary"
                    onChange={e => {
                      setCounselingHours(e.target.value);
                    }}
                  />
                  <span>No</span>
                </label>
