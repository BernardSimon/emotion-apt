module EmotionApt::user_info {
  ...
  public entry fun register(account: &signer, valid_msg: String, name: String, sex: String, date_of_birth: String, education: String, ocupation: String, counselinghours:String, orientations: String, techniques: String ) acquires UserInfo {
