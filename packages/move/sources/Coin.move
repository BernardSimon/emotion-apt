...
module EmotionApt::emotion_coin {
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store::create_primary_store_enabled_fungible_asset(
            ...
            8, /* decimals */
            utf8(b"http://47.253.216.82/favicon.ico"), /* icon */
            utf8(b"http://47.253.216.82"), /* project */
        );
    ...
    public fun get_metadata(): Object<Metadata> {
        let asset_address = object::create_object_address(&@EmotionApt, ASSET_SYMBOL);
    ...
    public entry fun set_pause(pauser: &signer, paused: bool) acquires State {
        ...
        let state = borrow_global_mut<State>(object::create_object_address(&@EmotionApt, ASSET_SYMBOL));
    ...
    fun assert_not_paused() acquires State {
        let state = borrow_global<State>(object::create_object_address(&@EmotionApt, ASSET_SYMBOL));
    ...
    #[test(creator = @EmotionApt, aaron = @0xface)]
